...
public class Ranger extends Hero {
    public Ranger(String name){
        super(name);
        this.levelAttributes = new HeroAttribute(1,7,1);         //Initial attributes for this class of Hero.
        validWeaponTypes = Arrays.asList(WeaponTypeEnum.Bow);                             //Valid weapons for this class of Hero.
