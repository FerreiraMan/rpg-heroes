...
public class RangerTest {
    ...
    void testLevelOneAttributes(){
        // arrange
        Ranger w = new Ranger(DUMMY_HERO_NAME);
    ...
    void testCantEquipWeaponWithHigherLevel(){
        ...
        Ranger w = new Ranger(DUMMY_HERO_NAME);
        w.levelUp(); // set the hero level to 2
        Weapon weapon = new Weapon(DUMMY_WEAPON_NAME, 3, SlotEnum.Weapon, WeaponTypeEnum.Bow, 10);
    ...
    void testDamageWarriorLevel2WithWeapon() throws InvalidWeaponException {
        ...
        Ranger w = new Ranger(DUMMY_HERO_NAME);
        w.levelUp(); // set the Hero level to 2
        Weapon weapon = new Weapon(DUMMY_WEAPON_NAME, 2, SlotEnum.Weapon, WeaponTypeEnum.Bow, 10);
        w.equip(weapon);
        // act
        double damageValue = w.damage();

        // assert
        double expected = 10 * (1 + (double) 12/100);
        assertEquals(expected, damageValue);
    }
    ...
    void testReplacingWeapon() throws InvalidWeaponException {
        ...
        Ranger w = new Ranger(DUMMY_HERO_NAME);
        w.levelUp(); // set the Hero level to 2
        Weapon weapon1 = new Weapon(DUMMY_WEAPON_NAME, 2, SlotEnum.Weapon, WeaponTypeEnum.Bow, 10);
        w.equip(weapon1);
        Weapon weapon2 = new Weapon(DUMMY_WEAPON_NAME, 2, SlotEnum.Weapon, WeaponTypeEnum.Bow, 8);
        w.equip(weapon2);
        ...
        // assert
        double expected = 8 * (1 + (double) 12/100);
        assertEquals(expected, damageValue);
    }
    ...
    void testDamageWeaponAndArmor() throws InvalidWeaponException, InvalidArmorException {
        // arrange
        Ranger w = new Ranger(DUMMY_HERO_NAME);
        Weapon weapon = new Weapon(DUMMY_WEAPON_NAME, 1, SlotEnum.Weapon, WeaponTypeEnum.Bow, 10);
        Armor armor = new Armor(DUMMY_ARMOR_NAME, 1, SlotEnum.Head, ArmorTypeEnum.Leather, new HeroAttribute(1,1,1));
        w.equip(weapon);
        w.equip(armor);
        ...
        // assert
        double expected = 10 * (1 + (double) (7+1)/100);
        assertEquals(expected, damageValue);
    }
