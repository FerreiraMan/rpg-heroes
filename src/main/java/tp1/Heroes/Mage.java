...
public class Mage extends Hero {
    public Mage(String name){
        super(name);
        this.levelAttributes = new HeroAttribute(1,1,8);          //Initial attributes for this class of Hero.
        validWeaponTypes = Arrays.asList(WeaponTypeEnum.Staff, WeaponTypeEnum.Wand);       //Valid weapons for this class of Hero.
        validArmorTypes = Arrays.asList(ArmorTypeEnum.Cloth);                              //Valid armor for this class of Hero.
    }
    ...
    //Method to calculate the damaging attribute of this Hero class. In this case its influenced by intelligence.
    @Override
    public int getDamagingAttribute() {

        return this.totalAttributes().getIntelligence();
    }
}
